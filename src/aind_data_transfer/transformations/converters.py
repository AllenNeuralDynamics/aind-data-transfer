...
def log_to_acq_json(log_dict: dict) -> Acquisition:
    ...
    axes.append(
        ImageAxis(
            name=AxisName.X, dimension=2, direction=AnatomicalDirection.AP
        )
    )
    axes.append(
        ImageAxis(
            name=AxisName.Y, dimension=1, direction=AnatomicalDirection.LR
        )
    )
    axes.append(
        ImageAxis(
            name=AxisName.Z, dimension=0, direction=AnatomicalDirection.IS
        )
    )
...
def schema_log_to_acq_json(log_dict: dict) -> Acquisition:
    ...
    axes.append(
        ImageAxis(
            name=AxisName.X, dimension=2, direction=AnatomicalDirection.LR
        )
    )
    axes.append(
        ImageAxis(
            name=AxisName.Y, dimension=1, direction=AnatomicalDirection.AP
        )
    )
    axes.append(
        ImageAxis(
